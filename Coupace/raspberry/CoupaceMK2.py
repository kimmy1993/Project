   ...
   def join(self):
       ...
       if (self.sentence1.get() != "" and self.sentence2.get() != ""
                       ...
                       for j in range(send_size+1):
                           ...
                           while(1):
                               ...
                               if (msg==str(0)):
                                   ...
                                   break
                           #data_buf=s.recv(2)
                       data_buf=s.recv(1).decode()
                       print(data_buf)
                       if not data_buf==str(1):
                           print("send error")
                           break
        ...
        """
         ...
         에러 처리
         """
           data_buf=s.recv(4).decode()
           if (data_buf=="fail"):
               print("얼굴 인식에 실패 하셧습니다 다시 촬영해 주세요")
               tk.messagebox.showinfo("","얼굴 인식에 실패 하셧습니다 다시 촬영해 주세요")
           else:
               print("JOIN!")
